...
class Humanoid extends CharacterStats {
  constructor(attritbutes) {
    super(attritbutes);
    this.team = attritbutes.team;
    this.weapons = attritbutes.weapons;
    this.language = attritbutes.language;
  }
  greet() {
...
class Villain extends Humanoid {
  constructor(atts) {
    super(atts);
    this.bodyParts = atts.bodyParts;
    this.father = atts.father;
    this.mother = atts.mother;
